...
const AppShowcase = () => {
  ...
  return (
    <section
      className="py-20 bg-[#F4EAFA] relative overflow-hidden"
      ref={containerRef}
    >
        ...
        <div className="text-center mb-16 space-y-4">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center mt-6">
            <Button
              variant="outline"
              size="lg"
              className="border-gray-200 cursor-pointer bg-white"
            >
              <Image
                src={"/play_store.png"}
                width={30}
            ...
            <Button
              variant="outline"
              size="lg"
              className="border-gray-200 cursor-pointer rounded-tr-xl bg-white text-shadow-black"
            >
              <Image
                src={"/app_store.png"}
                width={30}
